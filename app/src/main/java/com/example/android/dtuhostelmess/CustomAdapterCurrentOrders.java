...
public class CustomAdapterCurrentOrders extends BaseAdapter implements View.OnClickListener {
    ...
    public CustomAdapterCurrentOrders(Activity a, ArrayList d, Resources resLocal) {
        //Take passed values
        activity = a;
        data = d;
        res = resLocal;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.tabitemorders, null);
    ...
    private class OnItemClickListener implements View.OnClickListener {
        ...
        public void onClick(View arg0) {
            CurrentOrders sct = (CurrentOrders) activity;
