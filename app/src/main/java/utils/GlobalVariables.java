...
public class GlobalVariables {
    ...
    public static int isAdminLogged;
    ...
    public static String currentHostel;
    public static String currentRoomNo;
    ...
    public static int QuantityItem3;
    public static int QuantityItem4;
    public static int QuantityItem5;
    public static int QuantityItem6;
    ...
    public static int PriceItem4;
    public static int PriceItem5;
    ...
    public static int totalItem3;
    public static int totalItem4;
    public static int totalItem5;
    public static int totalItem6;
